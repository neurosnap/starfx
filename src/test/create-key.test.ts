...
import { afterAll, beforeAll, expect, test } from "../test.js";
...
test("options object keys order for action key identity - 0: empty options", () => {
  console.warn = () => {};
  const api = createApi();
  api.use(api.routes());
  // no param
...
test("options object keys order for action key identity - 1: simple object", () => {
  const api = createApi();
  api.use(api.routes());
  // no param
...
test("options object keys order for action key identity - 2: object (with array values)", () => {
  interface Ip0 {
    param1: string;
    param2: string[];
  }
...
test("options object keys order for action key identity - 3: nested object", () => {
  interface Ip0 {
    param1: string;
    param2: string[];
  }
...
test("options object keys order for action key identity - 4: deepNested object", () => {
  interface Ip0 {
    param1: string;
    param2: string[];
  }
...
test("options object keys order for action key identity - 5: other", () => {
  const api = createApi();
  api.use(api.routes());
  //array options
